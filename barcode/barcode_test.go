...
// TestGetUnscaledBarcodeDimensions shows that the width and height returned by
// the function match that of the barcode
...
// TestBarcodeNonIntegerScalingFactors shows that the barcode may be scaled to
// non-integer sizes
